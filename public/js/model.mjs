...
export function setGameMode(target) {
    switch (target) {
        case view.localBotBtn:
            currentGameMode = GameMode.LOCAL_BOT;
            break;
        case view.serverBotBtn:
            currentGameMode = GameMode.SERVER_BOT;
            break;
    }
}
...
function adjustLengthIfNeeded(rankingType) {
    switch (rankingType) {
        case "local":
            if (localRanking.length > MAX_LENGTH_OF_RANKING) localRanking.length = MAX_LENGTH_OF_RANKING;
            break;
        case "server":
            if (serverRanking.length > MAX_LENGTH_OF_RANKING) serverRanking.length = MAX_LENGTH_OF_RANKING;
            break;
        case "history":
